...
def render_html(ledger: Ledger, cfg: AlertConfig) -> str:
    ...
    parts.append("<footer>Generated by weighing_machine (Zero Alerts, "
                 "https://github.com/suph-steadily/zero-alerts-weighing-machine). Rules of the road: name your NOC denominator; "
