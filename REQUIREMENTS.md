...
| A NOC | agent side: cure split. 74% cure; cured costs ~0 to -2% of that agent's next-year binds per event; uncured cancellation ~ -20%, front-loaded (most of the damage lands early) | agent side partially priced; customer side UNPRICED | scratch-darren `2026-08-noc-impact-inde-agent/` (REPORT.md + tradeoff.py); Darren's early data via LaNae 8/18 |
